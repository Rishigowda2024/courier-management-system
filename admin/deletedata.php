...
<style>
    body {
        background-image: url('../images/anirudh-KmQbT4FQvGQ-unsplash.jpg');
...
<div class="admintitle">
    <div>
    <h5 ><a href="dashboard.php" style="float: left; margin-left:20px; color:white;">BackToDashboard</a></h5>
    <h5 ><a href="logout.php" style="float: right; margin-right:20px; color:white;">LogOut</a></h5>
    </div>
    <h1 align='center' style="text-shadow: 0.1em 0.1em 0.15em #a2e4f5;">SEARCH DATA INFORMATION</h1>
</div>
