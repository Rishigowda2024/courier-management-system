...
<body bgcolor="#3f54be">
    <h5><a href="../index.php" style="float: right; margin-right:50px; color:white">BackToHome</a></h5><br>
    <h1 align='center' style="color: white;font-size:60px">ADMIN LOGIN </h1>
    <h6 align='center' style="color: white;font-weight: bold;font-size:15px">ONLY FOR ADMINS :)</h6>
