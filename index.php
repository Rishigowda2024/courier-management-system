...
<body>
    <h1 align='center' style="margin: 15px; color:#480ca8;font-weight: bold;font-family:'Times New Roman', Times, serif">COURIER MANAGEMENT SYSTEM</h1>
    <hr />
    <P align='center' style="font-weight: bold;color:orange;font-family:'Times New Roman', Times, serif"> BEST IN COURIER SERVICE </P>
    <div>
